...
CREATE INDEX IF NOT EXISTS idx_acquisition_sessions_owner_status ON acquisition_sessions(owner_user_id, status, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_acquisition_sessions_landing_root ON acquisition_sessions(landing_storage_root_id, landing_relative_path);
CREATE INDEX IF NOT EXISTS idx_acquisition_sessions_raw_dataset_id ON acquisition_sessions(raw_dataset_id);
CREATE INDEX IF NOT EXISTS idx_acquisition_sessions_experiment_project_id ON acquisition_sessions(experiment_project_id);

# DetecDiv Hub — Deployment Playbook

This file is the canonical source of truth for deployment procedures.
It is read by both Claude Code (`/detecdiv-hub-ops`) and Codex (`detecdiv-hub-ops`).
